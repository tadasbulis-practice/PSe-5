...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        bool linqOnly = args.Contains("--linq-only");

        bool noLinqOnly = args.Contains("--nolinq-only");
        ...
        if (linqOnly)
        {
            Console.WriteLine("[INFO] Showing ONLY LINQ implementations.");
        }

        if (noLinqOnly)
        {
            Console.WriteLine("[INFO] Showing ONLY no-LINQ implementations.");
        }
        ...
        var studentService =
            new StudentService(repository, validator, calculator);

        var reportService =
            new ReportService(repository, calculator);
