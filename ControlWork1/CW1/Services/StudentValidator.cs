...
/// Validates a Student against business rules.
/// Returns a list of error messages; empty list means the student is valid.
/// Receives IStudentRepository via constructor injection.
...
public class StudentValidator
{
    ...
    public List<string> Validate(Student student)
    {
        ...
        if (_repository.GetAllGroups().All(g => g.Code != student.GroupCode))
